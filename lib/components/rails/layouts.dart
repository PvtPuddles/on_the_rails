...
abstract final class Layouts {
  static final test = [
    Straight1(coord: const CellCoord(0, 1), angle: pi),
    Bend2x2(coord: const CellCoord(0, 2)),

    // T
    Straight1(coord: const CellCoord(0, -1), angle: pi / 2),
    Straight1(coord: const CellCoord(0, 0), angle: pi / 2),
  ...
  static final loop = [
    ...
    Straight1(coord: const CellCoord(0, -2), angle: pi),
    Bend2x2(coord: const CellCoord(2, -1), angle: -pi / 2),

    // Right side
    Straight1(coord: const CellCoord(2, 0), angle: pi / 2),
    Straight1(coord: const CellCoord(2, 1), angle: pi / 2),

    // Bottom bends
    Bend2x2(coord: const CellCoord(1, 3), angle: 0),
    Straight1(coord: const CellCoord(0, 3), angle: pi),
  ...
  static final figureEight = [
    // Horizontal
    Straight1(coord: const CellCoord(-1, 0), angle: 0),
    Straight1(coord: const CellCoord(0, 0), angle: 0),
    Straight1(coord: const CellCoord(1, 0), angle: 0),
  ...
  static final cloverPlus = [
    ...clover,
    for (int x = 0; x < 3; x++) Straight1(coord: CellCoord(-1 + x, -3)),
    for (int x = 0; x < 3; x++) Straight1(coord: CellCoord(-1 + x, 3)),
    for (int y = 0; y < 3; y++)
      Straight1(coord: CellCoord(-3, -1 + y), angle: pi / 2),
    for (int y = 0; y < 3; y++)
      Straight1(coord: CellCoord(3, -1 + y), angle: pi / 2),
